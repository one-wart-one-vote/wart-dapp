...
class Register(QDialog):
    def __init__(self, parent):
        ...
        self.parent = parent
        self.register.hide_btn.clicked.connect(self.showMinimized)
        self.register.close_btn.clicked.connect(self.close_)
...
class Login(QDialog):
    def __init__(self, parent, addr):
        ...
        self.addr = addr
        self.login.hide_btn.clicked.connect(self.showMinimized)
        self.login.close_btn.clicked.connect(self.close)
        self.setWindowFlags(Qt.FramelessWindowHint)
...
class Confirm(QDialog):
    def __init__(self):
        ...
        self.confirm.hide_btn.clicked.connect(self.showMinimized)
        self.confirm.close_btn.clicked.connect(self.close)
...
class PrivkeyRestore(QDialog):
    def __init__(self, parent):
        ...
        self.parent = parent
        self.key.hide_btn_2.clicked.connect(self.showMinimized)
        self.key.close_btn_2.clicked.connect(self.close)
        self.setWindowFlags(Qt.FramelessWindowHint)
...
class MnemoRestore(QDialog):
    def __init__(self, parent):
        ...
        self.parent = parent
        self.addmnemo.hide_btn_2.clicked.connect(self.showMinimized)
        self.addmnemo.close_btn_2.clicked.connect(self.close)
...
class Mnemon(QDialog):
    def __init__(self, words, parent):
        ...
        self.words = words
        self.parent = parent
        self.mnemon.close_btn.clicked.connect(self.close)
        self.mnemon.hide_btn.clicked.connect(self.showMinimized)
...
class WartWallets(QMainWindow):
    def __init__(self):
        ...
        self.wallets.close_btn.clicked.connect(self.close)
        self.wallets.hide_btn.clicked.connect(self.hide_window)
...
class WartEntry(QMainWindow):
    def __init__(self):
        ...
        self.ui.hide_btn.clicked.connect(self.hide_window)
    ...
    def public_connect(self):
        ...
        for i in PUBLIC_NODES:
            QApplication.processEvents()
            try:
                req = requests.get(f'http://{ip}', timeout=2)
